    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" >
        <ul class="navbar-nav ms-auto">  
                ...
                <li class="nav-item mt-2 mx-2"> 
                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="current user = <?=$_SESSION['user']?>"><i class="fa-solid fa-user" style="color: gray;"></i></a> 
                    <!-- <i title="current user = <?=$_SESSION["user"]?>" class="fa-solid fa-user" style="color: gray;"></i>  -->
                </li>  
                <?php endif ?>
            </ul>             
        </div>
